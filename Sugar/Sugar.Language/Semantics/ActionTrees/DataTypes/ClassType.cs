...
namespace Sugar.Language.Semantics.ActionTrees.DataTypes
{
    internal class ClassType : DataTypeWrapper<ClassNode>, IGeneralContainer
    {
        ...
        public IFunctionContainer<MethodDeclarationStmt, VoidDeclarationStmt> AddDeclaration(MethodDeclarationStmt declaration) => AddGlobalMember<ClassType>(GlobalMemberEnum.Function, declaration);

        public IFunctionContainer<MethodDeclarationStmt, VoidDeclarationStmt> AddDeclaration(VoidDeclarationStmt declaration) => AddGlobalMember<ClassType>(GlobalMemberEnum.Void, declaration);
